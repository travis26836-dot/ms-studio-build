      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Manus Design Studio exposes a tRPC-based API that enables
            programmatic control of all design operations. Every action
            available in the visual editor can be performed via the API, making
            it suitable for automation, batch processing, and integration with
            external tools.
          </p>
        </div>
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-3">
                  <p className="text-xs text-muted-foreground">
                    ...
                    uses session cookies from Manus OAuth.
                  </p>
                  <CodeBlock
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-4">
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    The Manus Design Studio VS Code extension enables a seamless
          ...
          <TabsContent value="automation">
            <div className="grid gap-6">
              <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-4">
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    The Manus Design Studio API is designed for full automation.
                    Combined with the Manus AI platform, every editor action can
                    be performed programmatically, enabling batch processing,
                    workflow automation, and AI-driven design generation at
                    scale.
                  </p>
                  <div className="space-y-3">
                    <h4 className="text-xs font-semibold text-card-foreground">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      The Manus platform can control the entire design workflow.
                      Every action available in the UI is also available via the
                      API:
                    </p>
