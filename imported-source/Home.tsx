            ...
            {Object.entries(CANVAS_PRESETS)
              ...
              .map(([key, preset]) => (
                <button
                  ...
                  onClick={() =>
                    setLocation(
                      `/editor?w=${preset.width}&h=${preset.height}&preset=${key}`
                    )
                  }
                      ...
                      >
                        <div className="w-full h-full flex flex-col items-center justify-center p-4">
                          <div
                            ...
                            style={{
                              background:
                                templateColors[i % templateColors.length],
                            }}
                          >
                            <FileText className="w-5 h-5 text-white" />
                          </div>
                          <p className="text-xs font-medium text-card-foreground text-center leading-tight">
                            {template.name}
                          </p>
                ...
                <div key={project.id} className="group relative">
                  ...
                  >
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      {project.canvasWidth}x{project.canvasHeight} &middot;{" "}
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              AI-powered tools, royalty-free assets, and developer integrations.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "107+ templates for menus, invitations, certificates, social media, flyers, and more.",
                },
                {
                  icon: ImageIcon,
                  title: "Asset Database",
                  desc: "Royalty-free photos, icons, shapes, and design elements.",
                },
                {
                  icon: Palette,
                  title: "Brand Kit",
                  desc: "Store your colors, fonts, and logos for consistent branding.",
                },
                {
                  icon: Bot,
                  title: "AI Assistant",
                  desc: "Conversational AI that suggests layouts and generates copy.",
                },
                {
                  icon: Download,
                  title: "Multi-Format Export",
                  desc: "Export as PNG, JPG, or PDF in any size or resolution.",
                },
                {
                  icon: Zap,
                  title: "VS Code Bridge",
                  desc: "Export designs directly into your development environment.",
                },
                {
                  icon: Code2,
                  title: "Manus API",
                  desc: "Programmatic control of all editor actions via REST API.",
                },
              ].map((feature, i) => (
                <Card
                  key={i}
              ...
              {[
                {
                  ...
                  desc: "Browse professional templates or start from a blank canvas in any size.",
                },
                {
                  step: "2",
                  title: "Customize your design",
                  desc: "Drag and drop elements, add text, images, and use AI tools to create.",
                },
                {
                  step: "3",
                  title: "Export & share",
                  desc: "Download in PNG, JPG, or PDF. Use the API to automate workflows.",
                },
              ].map(item => (
        ...
        <section className="py-20 px-6 bg-card/50">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join Manus Design Studio and start creating professional designs
